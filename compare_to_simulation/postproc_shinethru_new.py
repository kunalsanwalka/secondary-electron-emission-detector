...
def calculate_line_integrated_densities(detDictList, args, logger):
    ...
    if gasType == 'Hydrogen':
        lookupTable = np.load('/home/whamdata/post_processing/shinethru_stuff/shine_thru_table.npz')
    elif gasType == 'Deuterium':
        lookupTable = np.load('/home/whamdata/post_processing/shinethru_stuff/shine_thru_table_d.npz')
    ...
    for i in range(len(detDictList)):
        ...
        try:
            ...
            try:
                ...
                lineIntegratedDensityTimeArr = detDict['time_arr_slow']
            ...
            try:
                ...
                try:
                    ...
                    lineIntegratedDensitySigmaNode = detNode.addNode('linedens_err', 'SIGNAL')
                lineIntegratedDensitySigma = detDict['line_integrated_density_sigma']
                lineIntegratedDensitySigmaTimeArr = detDict['time_arr_slow']
...
def run_post_process(args, logger):
    ...
    pickleFilePath = '/home/whamdata/post_processing/shinethru_stuff/see_detector_dictionary.pkl'
