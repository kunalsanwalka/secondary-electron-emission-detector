...
#digIP = '192.168.130.164'  # CHECK
digIP = '192.168.113.164' # 
digName = 'acq1001_639'
...
def run_post_process(logger,args):
    ...
    dtacqToDiodeMap = {
        # D1 mapping (1_CH_xx)
        'CH_42': '1_CH_20', 'CH_41': '1_CH_19', 'CH_40': '1_CH_18', 'CH_39': '1_CH_17', 'CH_38': '1_CH_16',
        'CH_37': '1_CH_15', 'CH_36': '1_CH_14', 'CH_35': '1_CH_13', 'CH_34': '1_CH_12', 'CH_33': '1_CH_11',
        'CH_21': '1_CH_10', 'CH_22': '1_CH_09', 'CH_23': '1_CH_08', 'CH_24': '1_CH_07', 'CH_25': '1_CH_06',
        'CH_26': '1_CH_05', 'CH_27': '1_CH_04', 'CH_28': '1_CH_03', 'CH_29': '1_CH_02', 'CH_30': '1_CH_01',

        # D2 mapping (2_CH_xx)
        'CH_20': '2_CH_20', 'CH_19': '2_CH_19', 'CH_18': '2_CH_18', 'CH_17': '2_CH_17', 'CH_16': '2_CH_16',
        'CH_15': '2_CH_15', 'CH_14': '2_CH_14', 'CH_13': '2_CH_13', 'CH_12': '2_CH_12', 'CH_11': '2_CH_11',
        'CH_10': '2_CH_10', 'CH_09': '2_CH_09', 'CH_08': '2_CH_08', 'CH_07': '2_CH_07', 'CH_06': '2_CH_06',
        'CH_05': '2_CH_05', 'CH_04': '2_CH_04', 'CH_03': '2_CH_03', 'CH_02': '2_CH_02', 'CH_01': '2_CH_01',

        # D3 mapping (3_CH_xx)
        'CH_43': '3_CH_20', 'CH_44': '3_CH_19', 'CH_45': '3_CH_18', 'CH_46': '3_CH_17', 'CH_47': '3_CH_16',
        'CH_48': '3_CH_15', 'CH_49': '3_CH_14', 'CH_50': '3_CH_13', 'CH_51': '3_CH_12', 'CH_52': '3_CH_11',
        'CH_53': '3_CH_10', 'CH_54': '3_CH_09', 'CH_55': '3_CH_08', 'CH_56': '3_CH_07', 'CH_57': '3_CH_06',
        'CH_58': '3_CH_05', 'CH_59': '3_CH_04', 'CH_60': '3_CH_03', 'CH_61': '3_CH_02', 'CH_62': '3_CH_01',
    }

    R_array_s1 = [
        10.00, 10.00, 10.01, 10.02, 10.02,
        10.00, 10.11, 10.02, 9.99 , 9.96 ,
        10.04, 10.04, 10.01, 10.04, 10.01,
        9.99 , 10.01, 9.98 , 9.98 , 9.97
    ]
    R_array_s2 = [
        217.6, 218.5, 218.2, 219.5, 219.4,
        219.9, 220.0, 219.4, 219.5, 220.4,
        219.2, 219.4, 219.7, 219.8, 220.0,
        219.5, 220.2, 220.2, 220.6, 220.4
    ]
    R_array_s3 = [
        218.9, 219.0, 218.8, 219.4, 219.1,
        219.0, 219.1, 219.0, 218.6, 219.3,
        218.8, 218.6, 219.0, 219.8, 218.7,
        220.2, 220.7, 220.2, 220.5, 220.6
    ]

    R_array = np.array([R_array_s1, R_array_s2, R_array_s3])  # shape: (3, 20)
...
# DE 24/08/15 I think these values are more accurate. They agree better with visual inspection inside the chamber. Measure these upon removal!!
    ...
    for n_idx, n in enumerate(nodename_list):

        axuv_raw = np.zeros((20,nsamp))
    # import raw data from MDSplus 
        for i in range(len(axuv_raw[:,0])):
            axuv_raw[i,:] = -rawTree.getNode(diodeToDtacqMap['{}_CH_{:02d}'.format(n_idx+1,i+1)]).getData().data()
    # Crude filter out highest frequency noise
        ...
        for idx in range(20):
            ...
            try:
                ...
                procTree.getNode(CH_Name+'.RESISTOR').putData(mds.Data.compile("BUILD_WITH_UNITS($1,'Ohm')",R_array[n_idx, idx]))
...
if __name__ == '__main__':
    ...
    for i in range(3):
        try:
            ...
            if i == 0:
                axuv_errorfile = open("/home/whamdata/post_processing/debugging/axuv_issue_"+str(args.shotnum)+"_kai.txt",'w')
            logger.info("Error running script:\n {}".format(traceback.format_exc()))
            print(traceback.format_exc())
            axuv_errorfile.write("Error running script:\n {}\n".format(traceback.format_exc()))
            time.sleep(1)   #Wait 1s before trying again
    try:
        axuv_errorfile.close()  #This will only be neccessary if there was an error
    except:
        pass
