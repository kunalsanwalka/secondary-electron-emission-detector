...
def load_detector_dictionary(pickleFilePath):
    ...
    try:
        ...
        print(f'Error occurred while loading detector dictionary from pickle file: {e}')
...
def load_raw_data(detDictList):
    ...
    try:
        ...
        print(f'Error occurred while loading raw data: {e}')
    ...
    if args.ref_shotnum != 0:
        ...
        try:
            ...
            print(f'Error occurred while loading raw data for reference shot: {e}')

    else:
        
        print('No reference shot specified, skipping loading raw data for reference shot.')
    ...
    if args.debug:
        ...
        print('Making plots of the raw signals for debugging.')
...
def compute_single_detector_see_density(i, detDictList, nbiVoltageArr, nbiTimeArr, shineThruTable, lineDensScanArr, nbiVoltageScanArr):
    ...
    print(f'Calculating SEE density for detector {i+1}.')
...
def calculate_line_integrated_densities(detDictList):
    ...
    print('Calculating line integrated densities.')

    if args.ref_shotnum == 0:
        
        print('No reference shot specified, skipping calculating line integrated densities.')
    ...
    print('Loading the NBI voltages for the plasma shot.')
    tree = mds.Tree('wham', args.shotnum)
    ...
    try:
        ...
        print(f'Gas type for this shot is {gasType}.')
        if args.debug:
            print(gasType)

    except:
        print('Error occurred while getting gas type from MDSplus, defaulting to Hydrogen.')
        gasType = 'Hydrogen'
    ...
    print('The shape of the shine-thru table is: '+str(shineThruTable.shape))
    print('The shape of the line density scan array is: '+str(lineDensScanArr.shape))
    print('The shape of the NBI voltage scan array is: '+str(nbiVoltageScanArr.shape))
    ...
    if args.debug:
        ...
        print('Making plots of the line integrated densities for debugging.')
        ...
        try:
            ...
            print(f'Error occurred while loading interferometer data from MDSplus: {e}')
...
if __name__ == "__main__":
    ...
    # Get the arguments
    args = parseArgs()
    print('Arguments parsed, now running post processing script.')
